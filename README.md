...
This application will allow you to input city name in a dropdown and will show you list of available cities using an API and will show all the details.

This application utilises - React, Jest & Enzyme Testing, Bootstrap.

Click on [Demo](https://saurabhgaur01.github.io/frontEndTest/) for quick view.
## Installation & Usage
...
## Contributing
1. Fork it ( https://github.com/SaurabhGaur01/frontEndTest/fork )
